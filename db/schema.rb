...
ActiveRecord::Schema.define(version: 20171201080828) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "adtifacts", force: :cascade do |t|
    t.string "name"
    t.string "key"
    t.bigint "project_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_adtifacts_on_project_id"
  end
  ...
  add_foreign_key "adtifacts", "projects"
